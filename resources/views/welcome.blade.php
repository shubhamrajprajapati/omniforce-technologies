    ...
    <div
        ...
        <div class="max-w-7xl mx-auto p-6 lg:p-8">
            ...
            <div id="footer-copyright">
                <div
                    class="flex justify-center mt-16 px-0 sm:items-center sm:justify-between space-x-4 divide-x divide-gray-300/10">
                    <div class="text-center text-sm text-gray-500 dark:text-gray-400 sm:text-left">
                        <div class="flex items-center gap-0">
                            <a href="{{route('home')}}"
                                class="group inline-flex items-center hover:text-gray-700 dark:hover:text-white focus:outline focus:outline-2 focus:rounded-sm focus:outline-red-500">
                                Copyright ©️ {{ date('Y') . ' ' . config('app.name') }}
                            </a>
                        </div>
                    </div>

                    <div class="pl-4 text-center text-sm text-gray-500 dark:text-gray-400 sm:text-right sm:ml-0">
